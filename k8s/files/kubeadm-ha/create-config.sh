...
export K8SHA_IPVIRTUAL=%(virtualIP)s

# master01 ip address
export K8SHA_IP1=%(masterIP1)s

# master02 ip address
export K8SHA_IP2=%(masterIP2)s

# master03 ip address
export K8SHA_IP3=%(masterIP3)s

# master01 hostname
export K8SHA_HOSTNAME1=%(masterName1)s

# master02 hostname
export K8SHA_HOSTNAME2=%(masterName2)s

# master03 hostname
export K8SHA_HOSTNAME3=%(masterName3)s
...
export K8SHA_CALICO_REACHABLE_IP=%(gateway)s
